...
def fmp_articles(
    ...
    :return: List of dicts or formatted string with article data.
...
def general_news(
    ...
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with general news data.
    ...
    return format_output(all_results, output)
...
def stock_news(
    ...
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with stock news data.
...
def mergers_acquisitions_rss_feed(
    ...
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with latest M&A news RSS feed data.
...
def upgrades_downgrades_rss_feed(
    ...
    :param page: Page number for pagination. Default is 0.
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with latest stock upgrades and downgrades data.
...
def upgrades_downgrades(
    ...
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with upgrade/downgrade data.
...
def press_releases(
    ...
    :param page: Page number for pagination. Default is 0.
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with press releases data.
