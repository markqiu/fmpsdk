...
def price_targets(
    ...
    :return: List of dicts or formatted string with price target data
...
def price_target_summary(
    ...
    :param symbol: Stock symbol (e.g., 'AAPL')
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with price target summary data
...
def price_target_consensus(
    ...
    :param symbol: Stock symbol (e.g., 'AAPL')
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with consensus price target data
...
def price_target_rss_feed(
    ...
    :param output: Output format ('tsv', 'json', or 'markdown'). Defaults to 'markdown'.
    :return: List of dicts or formatted string with price target updates
